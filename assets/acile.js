...
(function () {
    ...
    w = Oa.Chart = (function () {
                    ...
                    for (z = 0; z < u.dataPoints.length; z++) {
                        ...
                        if (0 < z) {
                            ...
                            null !== e &&
                                ...
                                (a.axisY.logarithmic
                                    ? ((A = e / u.dataPoints[z - 1].y), 1 > A && (A = 1 / A), d.minDiff > A && 1 !== A && (d.minDiff = A))
                                    : ((A = e - u.dataPoints[z - 1].y), 0 > A && (A *= -1), d.minDiff > A && 0 !== A && (d.minDiff = A)));
                        }
                        if (b < q && !h) null !== e && (n = b);
                        else {
                            if (!h && ((h = !0), 0 < z)) {
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, u = !1, z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    for (p = 0; p < h.dataPoints.length; p++) {
                        ...
                        0 < p &&
                            (a.axisX.logarithmic
                                ? ((A = b / h.dataPoints[p - 1].x), 1 > A && (A = 1 / A), c.minDiff > A && 1 !== A && (c.minDiff = A))
                                : ((A = b - h.dataPoints[p - 1].x), 0 > A && (A *= -1), c.minDiff > A && 0 !== A && (c.minDiff = A)),
                            e &&
                                null !== e[0] &&
                                h.dataPoints[p - 1].y &&
                                null !== h.dataPoints[p - 1].y[0] &&
                                (a.axisY.logarithmic
                                    ? ((A = e[0] / h.dataPoints[p - 1].y[0]), 1 > A && (A = 1 / A), d.minDiff > A && 1 !== A && (d.minDiff = A))
                                    : ((A = e[0] - h.dataPoints[p - 1].y[0]), 0 > A && (A *= -1), d.minDiff > A && 0 !== A && (d.minDiff = A))));
                        if (!(b < m) || n) {
                            if (!n && ((n = !0), 0 < p)) {
                                p -= 2;
                                g = k;
            ...
            for (l = 0; l < h.length; l++) {
                ...
                if (isFinite(n.dataInfo.minDiff))
                    if (
                        ...
                        !(
                            f ||
                            (!(this.panEnabled && n.scaleBreaks && n.scaleBreaks._appliedBreaks.length) && ((n.logarithmic && A < Math.pow(n.dataInfo.minDiff, 3)) || (!n.logarithmic && A < 3 * Math.abs(n.dataInfo.minDiff)))) ||
                            q < n.minimum ||
                            g > n.maximum
                        ))
                    )
                ...
                if (null !== C && "" !== C) {
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== t
                            ? ((e = c.y1),
                              (f = c.y2),
                              0 < J
                                  ? ((q = h.point.y - z / 2 - l - b), q < e && ((q = "auto" === t ? Math.max(h.point.y, e) + z / 2 + l + b : e + z / 2 + l + b), (v = q + z > h.point.y)))
                                  : ((q = h.point.y + z / 2 + l + b), q > f - z - l - b && ((q = "auto" === t ? Math.min(h.point.y, f) - z / 2 - l - b : f - z / 2 - l - b), (v = q < h.point.y))))
                        ...
                        0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? ((t = "auto"), (e = 4)) : 0 <= p.indexOf("stacked") ? "auto" === t && (t = "inside") : "bubble" === p && (t = "inside"),
                            ...
                            "inside" !== t
                                ? ((l = c.x1),
                                  (f = c.x2),
                                  0 > J
                                      ? ((n = h.point.x - ("horizontal" === x ? u : u / 2) - e - b), n < l && ((n = "auto" === t ? Math.max(h.point.x, l) + e + b : l + e + b), (v = n + u > h.point.x)))
                                      : ((n = h.point.x + ("horizontal" === x ? 0 : u / 2) + e + b),
                                        n > f - u - e - b && ((n = "auto" === t ? Math.min(h.point.x, f) - ("horizontal" === x ? u : u / 2) - e - b : f - u - e - b), (v = n < h.point.x))))
                                : ((l = Math.max(h.bounds.x1, c.x1)),
                                  ...
                                  (n = 0 > J ? Math.max(h.point.x, b) - ("horizontal" === x ? u / 2 : 0) : Math.min(h.point.x, b) - u / 2),
                                  (n = Math.max(n, l)));
                    "vertical" === x && (q += z / 2);
                    g.x = n;
                    g.y = q;
                    ...
                    m &&
                        ...
                        0 <= p.indexOf("bar") || ("error" === p && h.axisSwapped)
                            ? d.lineTo(n - (0 < h.direction ? 0 : -u) + ("vertical" === x ? -u / 2 : 0), q + ("vertical" === x ? -z / 2 : 0))
                            : 0 <= p.indexOf("column") || ("error" === p && !h.axisSwapped)
                            ? d.lineTo(n + ("horizontal" === x ? u / 2 : 0), q + ((0 < h.direction ? z : -z) + ("vertical" === x ? -z : 0)) / 2)
                            : d.lineTo(n + ("horizontal" === x ? u / 2 : 0), q + ((q < h.point.y ? z : -z) + ("vertical" === x ? -z : 0)) / 2),
                        d.stroke());
                }
            }
                        ...
                        for (var J = !1, t = 0; t < p.length; t++)
                            if (((x = p[t].x.getTime ? p[t].x.getTime() : p[t].x), !(x < a.axisX.dataInfo.viewPortMin || (x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !J)))))
                                if ("number" !== typeof p[t].y) 0 < t && !(h.connectNullData || J || m) && (c.stroke(), s && b.stroke()), (J = !0);
                                    ...
                                    l = { x: x, y: r };
                                    t < p.length - 1 &&
                                        (k !== (p[t].lineColor || A) || n !== (p[t].lineDashType || h.lineDashType)) &&
                                        (c.stroke(),
                                        c.beginPath(),
                                        c.moveTo(x, r),
                                        (k = p[t].lineColor || A),
                                    ...
                                    (p[t].indexLabel || h.indexLabel || p[t].indexLabelFormatter || h.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "line", dataPoint: p[t], dataSeries: h, point: { x: x, y: r }, direction: 0 > p[t].y === a.axisY.reversed ? 1 : -1, color: A });
                                }
                        c.stroke();
                        s && b.stroke();
                    }
                                ...
                                if ("number" !== typeof p[t].y) 0 < t && !(h.connectNullData || J || m) && (c.stroke(), s && b.stroke()), (J = !0);
                                    ...
                                    m || J
                                        ? (!m && h.connectNullData
                                              ...
                                              : (c.beginPath(), c.moveTo(x, r), s && (b.beginPath(), b.moveTo(x, r))),
                                          (J = m = !1))
                                        : (c.lineTo(x, B), s && b.lineTo(x, B), c.lineTo(x, r), s && b.lineTo(x, r), 0 == t % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, r), s && (b.stroke(), b.beginPath(), b.moveTo(x, r))));
                                    l = { x: x, y: r };
                                    t < p.length - 1 &&
                                        (k !== (p[t].lineColor || A) || n !== (p[t].lineDashType || h.lineDashType)) &&
                                        (c.stroke(),
                                        ...
                                        c.setLineDash && (p[t].lineDashType ? ((n = p[t].lineDashType), c.setLineDash(Q(n, h.lineThickness))) : ((n = h.lineDashType), c.setLineDash(g))));
                                    if (0 < p[t].markerSize || 0 < h.markerSize)
                                        (B = h.getMarkerProperties(t, x, r, c)), f.push(B), (y = S(y)), s && f.push({ x: x, y: r, ctx: b, type: B.type, size: B.size, color: y, borderColor: y, borderThickness: B.borderThickness });
                                    (p[t].indexLabel || h.indexLabel || p[t].indexLabelFormatter || h.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stepLine", dataPoint: p[t], dataSeries: h, point: { x: x, y: r }, direction: 0 > p[t].y === a.axisY.reversed ? 1 : -1, color: A });
                                }
                        c.stroke();
                        s && b.stroke();
                    }
                        ...
                        for (x = !1, m = 0; m < p.length; m++)
                            if (((t = p[m].getTime ? p[m].x.getTime() : p[m].x), !(t < a.axisX.dataInfo.viewPortMin || (t > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !x)))))
                                if ("number" !== typeof p[m].y)
                                    ...
                                    r[r.length] = { x: t, y: x };
                                    m < p.length - 1 &&
                                        (k !== (p[m].lineColor || A) || n !== (p[m].lineDashType || h.lineDashType)) &&
                                        ((k = p[m].lineColor || A),
                                    ...
                                    (p[m].indexLabel || h.indexLabel || p[m].indexLabelFormatter || h.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "spline", dataPoint: p[m], dataSeries: h, point: { x: t, y: x }, direction: 0 > p[m].y === a.axisY.reversed ? 1 : -1, color: A });
                                    x = !1;
                                }
                    d(r);
                }
                    ...
                    if (0 < A.length)
                        for (var k = 5 < n && g.bevelEnabled ? !0 : !1, f = 0; f < A.length; f++)
                            if ((A[f].getTime ? (z = A[f].x.getTime()) : (z = A[f].x), !(z < a.axisX.dataInfo.viewPortMin || z > a.axisX.dataInfo.viewPortMax) && "number" === typeof A[f].y)) {
                                ...
                                (A[f].indexLabel || g.indexLabel || A[f].indexLabelFormatter || g.indexLabelFormatter) &&
                        ...
                        for (h = 0; h < t.length; h++)
                            if (((b = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y)) {
                                ...
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y))
                                    (u[b] = t[h].y + (u[b] ? u[b] : 0)), 0 < u[b] && ((n = a.axisY.convertValueToPixel(u[b])), (B = "undefined" !== typeof f[b] ? f[b] : q), (f[b] = n));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y)
                                    (z[b] = t[h].y + (z[b] ? z[b] : 0)), (B = a.axisY.convertValueToPixel(z[b])), (n = "undefined" !== typeof l[b] ? l[b] : q), (l[b] = B);
                                else if (((n = a.axisY.convertValueToPixel(t[h].y)), 0 <= t[h].y)) {
                                    var y = "undefined" !== typeof f[b] ? f[b] : 0;
                                    n -= y;
                                    B = q - y;
                                    f[b] = y + (B - n);
                                } else (y = l[b] ? l[b] : 0), (B = n + y), (n = q + y), (l[b] = y + (B - n));
                        ...
                        for (var r = 5 < g && m.bevelEnabled ? !0 : !1, h = 0; h < t.length; h++)
                            if (((b = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y)) {
                                ...
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y)) {
                                    ...
                                    (z[b] = n + ("undefined" !== typeof z[b] ? z[b] : 0)), (B = a.axisY.convertValueToPixel(z[b])), (n = l[b] ? l[b] : q), (l[b] = B);
                        ...
                        for (h = 0; h < t.length; h++)
                            if (((b = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y)) {
                                ...
                                var C = (n - (a.plotType.plotUnits.length * g) / 2 + a.index * g) << 0,
                                    ...
                                    B;
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y))
                                    (u[b] = t[h].y + (u[b] ? u[b] : 0)), 0 < u[b] && ((B = f[b] ? f[b] : q), (f[b] = p = a.axisY.convertValueToPixel(u[b])));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) (z[b] = t[h].y + (z[b] ? z[b] : 0)), (p = l[b] ? l[b] : q), (l[b] = B = a.axisY.convertValueToPixel(z[b]));
                    ...
                    if (0 < t.length) {
                        ...
                        for (h = 0; h < t.length; h++)
                            if (((b = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y)) {
                                ...
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) (z[b] = C + (z[b] ? z[b] : 0)), (p = l[b] ? l[b] : q), (l[b] = C = a.axisY.convertValueToPixel(z[b]));
                                ...
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: C, y1: J, x2: p, y2: B };
                                b = S(b);
        ...
        m.prototype.renderArea = function (a) {
            ...
            function b() {
                B &&
                    ...
                    a.axisY.logarithmic || (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum) ? (J = C) : 0 > a.axisY.viewportMaximum ? (J = u.y1) : 0 < a.axisY.viewportMinimum && (J = C),
                    f.lineTo(m, J),
                    f.lineTo(B.x, J),
                    f.closePath(),
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < A.length) {
                        ...
                        for (var ha = !0; k < A.length; k++)
                            if (((r = A[k].x.getTime ? A[k].x.getTime() : A[k].x), !(r < a.axisX.dataInfo.viewPortMin || (r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ha)))))
                                if ("number" !== typeof A[k].y) g.connectNullData || ha || d || b(), (ha = !0);
                                    ...
                                    d || ha
                                        ? (!d && g.connectNullData
                                              ? (f.setLineDash &&
                                                    ...
                                                    ((d = m), (c = t), (m = p.x), (t = p.y), b(), f.moveTo(p.x, p.y), (m = d), (t = c), (B = p), (c = g.nullDataLineDashType), f.setLineDash(K)),
                                                f.lineTo(m, t),
                                                s && l.lineTo(m, t))
                                              : (f.beginPath(), f.moveTo(m, t), s && (l.beginPath(), l.moveTo(m, t)), (B = { x: m, y: t })),
                                          (ha = d = !1))
                                        : (f.lineTo(m, t), s && l.lineTo(m, t), 0 == k % 250 && b());
                                    p = { x: m, y: t };
                                    k < A.length - 1 &&
                                        (w !== (A[k].lineColor || v) || c !== (A[k].lineDashType || g.lineDashType)) &&
                                        (b(),
                                        (w = A[k].lineColor || v),
                                        (f.strokeStyle = w),
                                        f.setLineDash && (A[k].lineDashType ? ((c = A[k].lineDashType), f.setLineDash(Q(c, g.lineThickness))) : ((c = g.lineDashType), f.setLineDash(P))));
                                    ...
                                    (A[k].indexLabel || g.indexLabel || A[k].indexLabelFormatter || g.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "area", dataPoint: A[k], dataSeries: g, point: { x: m, y: t }, direction: 0 > A[k].y === a.axisY.reversed ? 1 : -1, color: y });
                                }
                        b();
                        Y.drawMarkers(z);
                    }
                        ...
                        for (A = !1; q < n.length; q++)
                            if (((g = n[q].x.getTime ? n[q].x.getTime() : n[q].x), !(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !A)))))
                                if ("number" !== typeof n[q].y)
                                    ...
                                    r[r.length] = { x: g, y: A };
                                    q < n.length - 1 &&
                                        (B !== (n[q].lineColor || J) || y !== (n[q].lineDashType || p.lineDashType)) &&
                                        ((B = n[q].lineColor || J),
                                    ...
                                    (n[q].indexLabel || p.indexLabel || n[q].indexLabelFormatter || p.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "splineArea", dataPoint: n[q], dataSeries: p, point: { x: g, y: A }, direction: 0 > n[q].y === a.axisY.reversed ? 1 : -1, color: C });
                                    A = !1;
                                }
                        d();
                        Y.drawMarkers(l);
                            ...
                            if (((r = A[k].x.getTime ? A[k].x.getTime() : A[k].x), !(r < a.axisX.dataInfo.viewPortMin || (r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))))) {
                                ...
                                "number" !== typeof A[k].y
                                    ...
                                    : ((m = a.axisX.convertValueToPixel(r)),
                                      ...
                                      d || c
                                          ? (!d && g.connectNullData
                                                ? (f.setLineDash &&
                                                      ...
                                                      ((d = m), (c = t), (m = p.x), (t = p.y), b(), f.moveTo(p.x, p.y), (m = d), (t = c), (B = p), (K = g.nullDataLineDashType), f.setLineDash(P)),
                                                  f.lineTo(m, $),
                                                  f.lineTo(m, t),
                                      ...
                                      (p = { x: m, y: t }),
                                      k < A.length - 1 &&
                                          (w !== (A[k].lineColor || v) || K !== (A[k].lineDashType || g.lineDashType)) &&
                                          (b(),
                                          (w = A[k].lineColor || v),
                                          (f.strokeStyle = w),
                                          f.setLineDash && (A[k].lineDashType ? ((K = A[k].lineDashType), f.setLineDash(Q(K, g.lineThickness))) : ((K = g.lineDashType), f.setLineDash(D)))),
                                      (r = g.dataPointIds[k]),
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!y.connectNullData || !$))))
                                if ("number" !== typeof ia.y) y.connectNullData || $ || x || d(), ($ = !0);
                                    ...
                                    x || $
                                        ? (!x && y.connectNullData
                                              ? (b.setLineDash &&
                                                    (y.options.nullDataLineDashType || (C === y.lineDashType && y.lineDashType !== y.nullDataLineDashType)) &&
                                                    ((x = h.pop()), (C = h[h.length - 1]), d(), b.moveTo(t.x, t.y), h.push(C), h.push(x), (C = y.nullDataLineDashType), b.setLineDash(P)),
                                                b.lineTo(g, k),
                                                s && r.lineTo(g, k))
                                    ...
                                    t = { x: g, y: k };
                                    q < v.length - 1 &&
                                        (K !== (v[q].lineColor || w) || C !== (v[q].lineDashType || y.lineDashType)) &&
                                        (d(),
                                        b.beginPath(),
                                        b.moveTo(g, k),
                                        h.push({ x: g, y: m - na }),
                                        (K = v[q].lineColor || w),
                                        (b.strokeStyle = K),
                                        b.setLineDash && (v[q].lineDashType ? ((C = v[q].lineDashType), b.setLineDash(Q(C, y.lineThickness))) : ((C = y.lineDashType), b.setLineDash(D))));
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!y.connectNullData || !$))))
                                if ("number" !== typeof ia.y) y.connectNullData || $ || O || d(), ($ = !0);
                                    ...
                                    O || $
                                        ? (!O && y.connectNullData
                                              ? (b.setLineDash &&
                                                ...
                                                b.lineTo(g, m),
                                                s && C.lineTo(g, m))
                                              : (b.beginPath(), b.moveTo(g, m), s && (C.beginPath(), C.moveTo(g, m))),
                                          ($ = O = !1))
                                        : (b.lineTo(g, m), s && C.lineTo(g, m), 0 == q % 250 && (d(), b.moveTo(g, m), s && C.moveTo(g, m), h.push({ x: g, y: x - ca })));
                                    r = { x: g, y: m };
                                    q < w.length - 1 &&
                                    ...
                                    0 <= y.dataPointIndexes[f] &&
                                        0 !== ia.markerSize &&
                                        (0 < ia.markerSize || 0 < y.markerSize) &&
                                        ((ca = y.getMarkerProperties(q, g, m, b)), u.push(ca), (f = S(F)), s && u.push({ x: g, y: m, ctx: C, type: ca.type, size: ca.size, color: f, borderColor: f, borderThickness: ca.borderThickness }));
                                    (ia.indexLabel || y.indexLabel || ia.indexLabelFormatter || y.indexLabelFormatter) &&
                            ...
                            if (
                                ...
                                "candlestick" === t.type
                                    ? (c.moveTo(k - w, p),
                                      ...
                                      c.lineTo(k - w, n),
                                      c.stroke(),
                                      da(c, v, Math.min(h, q), B, Math.max(h, q), x[u].y[0] <= x[u].y[3] ? t.risingColor : f, y, e, C, C, !1, !1, t.fillOpacity),
                                      s &&
                                          ((e = S(D)),
                                          (b.strokeStyle = e),
                                          b.moveTo(k - w, p),
                                          ...
                                          b.lineTo(k - w, n),
                                          b.stroke(),
                                          da(b, v, Math.min(h, q), B, Math.max(h, q), e, 0, null, !1, !1, !1, !1)))
                                    : "ohlc" === t.type &&
                                      (c.moveTo(k - w, p),
                                      c.lineTo(k - w, n),
                                      c.stroke(),
                        ...
                        for (var v = 5 < m && x.bevelEnabled ? !0 : !1, l = 0; l < C.length; l++)
                            if (
                                ...
                                s &&
                                    ...
                                    da(b, B, Math.max(h, p), y, Math.min(h, p), e, 0, null, !1, !1, !1, !1),
                                    0 < P && (b.beginPath(), (b.lineWidth = P), b.moveTo(u + $ / 2, n - ia), b.lineTo(u - $ / 2, n - ia), b.stroke(), b.moveTo(u + $ / 2, k + ia), b.lineTo(u - $ / 2, k + ia), b.stroke()));
                                (C[l].indexLabel || x.indexLabel || C[l].indexLabelFormatter || x.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: x.type,
                                        dataPoint: C[l],
                                        dataSeries: x,
                    ...
                    if (0 < B.length)
                        for (var E = v._colorSet, u = 0; u < B.length; u++) {
                            ...
                            var P = {
                                ...
                                dashType: B[u].stemDashType ? B[u].stemDashType : v.stemDashType,
                            };
                            ...
                            if (!(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && !r(B[u].y) && B[u].y.length && "number" === typeof B[u].y[0] && "number" === typeof B[u].y[1]) {
                                ...
                                if (B[u].indexLabel || v.indexLabel || B[u].indexLabelFormatter || v.indexLabelFormatter)
                                    this._indexLabels.push({
                                        ...
                                        dataSeries: v,
                                        indexKeyword: 0,
                                        point: { x: b ? (B[u].y[1] >= B[u].y[0] ? p : n) : p + (n - p) / 2, y: b ? q + (g - q) / 2 : B[u].y[1] >= B[u].y[0] ? g : q },
                                        ...
                                        this._indexLabels.push({
                                            ...
                                            dataSeries: v,
                                            indexKeyword: 1,
                                            point: { x: b ? (B[u].y[1] >= B[u].y[0] ? n : p) : p + (n - p) / 2, y: b ? q + (g - q) / 2 : B[u].y[1] >= B[u].y[0] ? q : g },
                                            direction: B[u].y[1] >= B[u].y[0] ? 1 : -1,
                                            bounds: { x1: b ? Math.min(p, n) : p, y1: b ? q : Math.min(q, g), x2: b ? Math.max(p, n) : n, y2: b ? g : Math.max(q, g) },
                                            color: e,
                                            axisSwapped: b,
                        ...
                        for (var K = !0; g < n.length; g++)
                            if (((t = n[g].x.getTime ? n[g].x.getTime() : n[g].x), !(t < a.axisX.dataInfo.viewPortMin || (t > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !K)))))
                                if (null !== n[g].y && n[g].y.length && "number" === typeof n[g].y[0] && "number" === typeof n[g].y[1]) {
                                    ...
                                    g < n.length - 1 &&
                                        (B !== (n[g].lineColor || w) || y !== (n[g].lineDashType || p.lineDashType)) &&
                                        (d(),
                                        (B = n[g].lineColor || w),
                                    ...
                                    if (n[g].indexLabel || p.indexLabel || n[g].indexLabelFormatter || p.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeArea", dataPoint: n[g], dataSeries: p, indexKeyword: 0, point: { x: m, y: r }, direction: n[g].y[0] > n[g].y[1] === a.axisY.reversed ? -1 : 1, color: C }),
                                            this._indexLabels.push({
                                                chartType: "rangeArea",
                                                dataPoint: n[g],
                                                dataSeries: p,
                        ...
                        for (g = !1; n < p.length; n++)
                            if (((q = p[n].x.getTime ? p[n].x.getTime() : p[n].x), !(q < a.axisX.dataInfo.viewPortMin || (q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g)))))
                                if (null !== p[n].y && p[n].y.length && "number" === typeof p[n].y[0] && "number" === typeof p[n].y[1]) {
                                    ...
                                    O[O.length] = { x: q, y: A };
                                    n < p.length - 1 &&
                                        (C !== (p[n].lineColor || x) || w !== (p[n].lineDashType || h.lineDashType)) &&
                                        ((C = p[n].lineColor || x),
                                        (r[r.length - 1].newStrokeStyle = C),
                                        b.setLineDash && (p[n].lineDashType ? ((w = p[n].lineDashType), (r[r.length - 1].newLineDashArray = Q(w, h.lineThickness))) : ((w = h.lineDashType), (r[r.length - 1].newLineDashArray = B))));
                                    if (0 !== p[n].markerSize && (0 < p[n].markerSize || 0 < h.markerSize)) {
                                        ...
                                        f.push(E);
                                        K = S(D);
                                        s && f.push({ x: q, y: A, ctx: e, type: E.type, size: E.size, color: K, borderColor: K, borderThickness: E.borderThickness });
                                    }
                                    if (p[n].indexLabel || h.indexLabel || p[n].indexLabelFormatter || h.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: p[n], dataSeries: h, indexKeyword: 0, point: { x: q, y: g }, direction: p[n].y[0] <= p[n].y[1] ? -1 : 1, color: t }),
                                            this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: p[n], dataSeries: h, indexKeyword: 1, point: { x: q, y: A }, direction: p[n].y[0] <= p[n].y[1] ? 1 : -1, color: t });
                                    g = !1;
                                } else
                                    0 < n &&
                                        !g &&
                        ...
                        for (var C = 5 < q && v.bevelEnabled ? !0 : !1, w = !1, B = null, y = null, l = 0; l < O.length; l++)
                            if ((O[l].getTime ? (p = O[l].x.getTime()) : (p = O[l].x), "number" !== typeof O[l].y)) {
                                ...
                                0 < l &&
                                    ...
                                    c.lineTo(K, P - x),
                                    0 < t && c.stroke(),
                                    s && (b.beginPath(), b.moveTo(B, y - x), b.lineTo(K, P - x), 0 < t && b.stroke()));
                                w = !1;
                                B = E;
                                y = 0 < O[l].y ? m : h;
                    ...
                    0 > c
                        ? ((n = "right" === m.hemisphere ? q : k),
                          ...
                          null !== n &&
                              ...
                              c - q < A && ((l = -q), (n = f(n, l, d + 1)), +n.toFixed(x) > +l.toFixed(x) && (h = c > A ? -(c - A) : -(q - (n - l))))))
                        : 0 < c &&
                          ...
                          null !== n &&
                              ...
                              c - q < A && ((l = q), (n = f(n, l, d + 1)), +n.toFixed(x) < +l.toFixed(x) && (h = c > A ? c - A : q - (l - n)))));
                    h &&
                        ((d = m.indexLabelTextBlock.y + h),
                        (c = 0),
                        (c = "right" === m.hemisphere ? C.x + Math.sqrt(Math.pow(s, 2) - Math.pow(d - C.y, 2)) : C.x - Math.sqrt(Math.pow(s, 2) - Math.pow(d - C.y, 2))),
                        ...
                        (m.indexLabelAngle = Math.atan2(m.indexLabelTextBlock.y - C.y, m.indexLabelTextBlock.x - C.x)));
                }
                return h;
            }
            function l() {
                            ...
                            if (null !== r) {
                                ...
                                if (0 > B) {
                                    ...
                                    var w = -1 * (B - t),
                                        I = (J = 0);
                                    "right" === k.hemisphere
                                        ? ((J = f(a, t)), (w = -1 * (B - J)), (I = f(r, w)), +I.toFixed(x) < +w.toFixed(x) && +J.toFixed(x) <= +t.toFixed(x) && f(a, -(w - I)))
                                        : ((J = f(r, t)), (w = -1 * (B - J)), (I = f(a, w)), +I.toFixed(x) < +w.toFixed(x) && +J.toFixed(x) <= +t.toFixed(x) && f(r, -(w - I)));
                                }
                            }
                        }
                    } else
                        for (a = 0; a < p.length; a++)
                            (k = g[a]), (s = "pie" === h.type ? 0.7 * y : 0.8 * y), (r = C.x + s * Math.cos(k.midAngle)), (t = C.y + s * Math.sin(k.midAngle)), (k.indexLabelTextBlock.x = r), (k.indexLabelTextBlock.y = t);
                    for (a = 0; a < p.length; a++)
                        if (((k = g[a]), (r = k.indexLabelTextBlock.measureText()), 0 !== r.height && 0 !== r.width))
                            (r = r = 0),
                                ...
                                0 < r &&
                                    ...
                                    Math.abs(k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - C.y) < y || Math.abs(k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2 - C.y) < y) &&
                                ...
                                0 < r &&
                                    ...
                                    Math.abs(k.indexLabelTextBlock.x - C.x) < y && ((r /= Math.abs(Math.sin(k.indexLabelAngle))), 9 < r && (r *= 0.3), r > d && (d = r)));
        ...
        m.prototype.renderFunnel = function (a) {
            ...
            function b() {
                if (t && x) {
                    for (var a, b, c, d, e, f, h, l, k, n, m, p, q, u, A = [], z = [], v = { percent: null, total: null }, C = null, y = 0; y < x.length; y++)
                        (u = R[y]), (u = "undefined" !== typeof u.x5 ? (u.y2 + u.y4) / 2 : (u.y2 + u.y3) / 2), (u = g(u).x2 + 1), (A[y] = N - u - W);
                    u = 0.5 * W;
                    for (var y = 0, B = x.length - 1; y < x.length || 0 <= B; y++, B--) {
                        ...
                        "inside" === t.indexLabelPlacement &&
                            ((A[y] = y !== da ? (t.reversed ? R[y].x2 - R[y].x1 : R[y].x3 - R[y].x4) : R[y].x3 - R[y].x6),
                            20 > A[y] && ((A[y] = y !== da ? (t.reversed ? R[y].x3 - R[y].x4 : R[y].x2 - R[y].x1) : R[y].x2 - R[y].x1), (A[y] /= 2)));
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (
                    var t = this.data[a.dataSeriesIndexes[0]], x = t.dataPoints, C = this.plotArea, D = 0.025 * C.width, B = 0.01 * C.width, y = 0, E = C.height - 2 * D, G = Math.min(C.width - 2 * B, 2.8 * C.height), K = !1, P = 0;
                    P < x.length;
                    P++
                )
                    if (
                    ...
                    if (-1 !== P) {
                        ...
                        for (F = 0; F < P.length - 1; F++)
                            (V = t.reversed ? (x[x.length - 1 - F].color ? x[x.length - 1 - F].color : t._colorSet[(x.length - 1 - F) % t._colorSet.length]) : x[F].color ? x[F].color : t._colorSet[F % t._colorSet.length]),
                                F === da
                                    ? R.push({ x1: a[F], y1: G[F], x2: B[F], y2: G[F], x3: Y, y3: xa, x4: B[F + 1], y4: G[F + 1], x5: a[F + 1], y5: G[F + 1], x6: M, y6: xa, id: F, height: G[F + 1] - G[F], color: V })
                                    : R.push({ x1: a[F], y1: G[F], x2: B[F], y2: G[F], x3: B[F + 1], y3: G[F + 1], x4: a[F + 1], y4: G[F + 1], id: F, height: G[F + 1] - G[F], color: V });
                        var ea = 2,
                            H = [],
                            ka = !1,
                            Z = [],
                        ...
                        for (var x = 0; x < n.dataPoints.length; x++) {
                            var w = n.dataPoints[x],
                                ...
                                g = w.legendText
                                    ...
                                    ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: n, dataPoint: w })
                                    : w.name
                                    ? w.name
                                    : "DataPoint: " + (x + 1),
                                A = w.legendMarkerColor ? w.legendMarkerColor : n.legendMarkerColor ? n.legendMarkerColor : w.color ? w.color : n.color ? n.color : n._colorSet[x % n._colorSet.length],
                                ...
                                q = { markerType: q, markerColor: A, text: g, textBlock: null, chartType: n.type, markerSize: s, dataSeriesIndex: p, dataPointIndex: x, markerBorderColor: v, markerBorderThickness: t };
                                    ...
                                    if (
                                        ...
                                        this.labelWrap
                                            ? r(this.options.labelMaxWidth)
                                                ? ((this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), p)),
                                                  (this.sessionVariables.labelWrap = this.labelWrap),
                                                  d && (A.width + d.width) >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25))
                                                : ((this.sessionVariables.labelWrap = this.labelWrap),
                                            ...
                                            ? ((this.sessionVariables.labelWrap = this.labelWrap),
                                              (this.sessionVariables.labelMaxHeight = l),
                                              (this.sessionVariables.labelMaxWidth = f),
                                              d && (A.width + d.width) >> 0 > 2 * f && ((this.sessionVariables.labelAngle = -25), (this.sessionVariables.labelMaxWidth = p)))
                                            : ((this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle),
                                              (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth),
                                              (this.sessionVariables.labelMaxHeight = l),
                                              (this.sessionVariables.labelWrap = this.labelWrap));
                                        ...
                                        if (r(this.options.labelWrap))
                                            if (!r(this.options.labelMaxWidth))
                                                ...
                                                if (((b = (A.width + d.width) >> 0), (g = this.labelFontSize), q < f))
                                                    b - 2 * f > n &&
                                                        ((n = b - 2 * f),
                                                        b >= 2 * f && b < 2.2 * f
                                                            ? ((this.sessionVariables.labelMaxWidth = f),
                                                    ...
                                                    for (this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, b = 0; b < this._labels.length; b++)
                                                        (a = this._labels[b].textBlock),
                                                            ...
                                                            b < this._labels.length - 1 &&
                                                                ...
                                                                (d = d.measureText()),
                                                                (A.width + d.width) >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25));
                                    }
                                else
                                    ((this.sessionVariables.labelAngle = this.labelAngle),
        ...
        D.setLayout = function (a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
                    for (var A = q[g].scaleBreaks._appliedBreaks, s = 0; s < A.length && !(A[s].startValue > q[g].viewportMaximum); s++)
                        A[s].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = s), A[s].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = s));
            for (var v = (s = 0), t = 0, x = 0, w = 0, D = 0, B = 0, y, E, G = (k = 0), I, P, L, A = (I = P = L = !1), g = 0; g < q.length; g++)
                q[g] &&
                    q[g].title &&
            ...
            if ("normal" === e) {
                for (var x = [], w = [], D = [], B = [], N = [], Q = [], S = [], T = []; 4 > s; ) {
                    ...
                    S.push(D);
                    if (b && 0 < b.length) for (B = [], g = ba = 0; g < b.length; g++) B.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), (ba += B[g]), (aa += b[g] ? b[g].margin : 0);
                        ...
                        for (g = 0; g < b.length; g++)
                            b[g] &&
                                ...
                                "inside" === b[g].labelPlacement &&
                                    0 < g &&
                                    ((b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (B[g] - b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2),
                                    (b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2)),
                                (b[g].bounds = { x1: l, y1: k, x2: m + (B[g] + X), y2: h, width: m - l, height: h - k }),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] &&
                                ...
                                (B = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - k.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle))));
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("rangeBar" === p[0].dataSeries.type || "error" === p[0].dataSeries.type)
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)), E = (C = t = 0), s = 0; s < p.length; s++)
                            if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++) (t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y[x]))), t < v && ((v = t), (w = s));
                            else
                                (C += p[s].dataPoint.y),
