...
?>
	...
	<form method="post" action="sur_jual.php" target="_blank">
	<div class="row">
	<div class="col-md-6">
		<h3 style="margin-top:5px">Cetak Surat Jual-Beli Untuk tanah :</h3>
	</div>
	<div class="col-md-6">
...
<hr style="margin:0; border-top:2px solid #ccc">
	...
	<div class="row">
 		<div class="col-md-6">
			<div class="input-group" style="padding:0">
				<span class="input-group-addon" id="basic-addon3" style="font-weight: bold; padding-right: 25px">Tahun Penjualan</span>
				<input type="text" name="tahunan" class="form-control" id="basic-alamat" aria-describedby="basic-addon3">
			</div>
			<div class="input-group" style="padding:0">
				<span class="input-group-addon" id="basic-addon3" style="font-weight: bold; padding-right: 15px">Luas Tanah Dijual</span>
				<input type="text" name="luasan" class="form-control" id="basic-alamat" aria-describedby="basic-addon3">
			</div>
		</div>
		<div class="col-md-6">
			<div class="input-group" style="padding:0">
				<span class="input-group-addon" id="basic-addon3" style="font-weight: bold; padding-right: 25px">Harga Jual</span>
				<input type="text" name="jualan" class="form-control" id="basic-alamat" aria-describedby="basic-addon3">
			</div>
			<div class="input-group" style="padding:0">
				<span class="input-group-addon" id="basic-addon3" style="font-weight: bold; padding-right: 15px">Terbilang</span>
				<input type="text" name="bilangan" class="form-control" id="basic-alamat" aria-describedby="basic-addon3">
			</div>
		</div>
	</div>
	<hr style="margin-top:10px; border-top:2px solid #ccc">
