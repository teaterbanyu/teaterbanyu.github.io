...
<div>
  ...
  <h3 style="text-align: center; line-height:0; margin-top:10px">TELAH MENGHIBAHKAN TANAH</h3>
...
<table style="font-size: 12pt; text-align: justify; line-height: 20px; width:100%">
  <tr>
    ...
    <td><?php 
    if(!isset($_POST['namapet'])){ echo $_POST['namasaya'] ;}else {echo $_POST['namapet'] ;}
   ?></td>    
  </tr>
  <tr>
...
<p style="text-align:center">Telah saya hibahkan pada tahun <?php if($_POST['tahunan'] != ''){echo $_POST['tahunan'];}else{echo "………………………";} ?></span> kepada :</p>
<table style="font-size: 12pt; text-align: justify; line-height: 20px; width:100%">
  <tr>
    <td >Nama</td>
    <td>:</td>    
